...
export function AdminSidebar({ activeTab, onTabChange, inquiriesCount, isOpen, onClose }: AdminSidebarProps) {
            ...
            {(isOpen || typeof isOpen === 'undefined') && (
                <>
                    ...
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        onClick={onClose}
                        className="fixed inset-0 bg-graphite-950/80 backdrop-blur-sm z-[60] lg:hidden"
                    />
                    ...
                    <motion.aside
                        ...
                        className={`fixed lg:sticky top-0 left-0 z-[70] w-80 bg-graphite-950 border-r border-white/5 flex flex-col h-screen overflow-hidden ${typeof isOpen === 'undefined' ? 'hidden lg:flex' : 'flex'}`}
                    >
                        {/* Background Staging */}
                        ...
                        <div className="p-8 md:p-10 relative z-10">
                            <Link to="/" className="flex items-center gap-4 group mb-8 md:mb-10">
                        ...
                        <div className="mt-auto p-8 md:p-10 relative z-10">
